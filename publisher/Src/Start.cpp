...
int main()
{
	...
	while (true)
	{
		...
		sleep(1);
#endif
		SendPScanResult(trans,i); //����ȫ������
		SendIFResult(trans, i);   //���Ͷ�Ƶ����
		SendDFResult(trans, i);   //���Ͳ�������
		SendPosResult(trans, i);  //���Ͷ�λ����
		SendDeviceStatus(trans,i);  //�����豸״̬
		//SendIntelligence(trans, i); //�����鱨��Ϣ
		i++;
	}
	trans.reset();
	zsys_shutdown();
